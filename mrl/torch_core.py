...
__all__ = ['get_device', 'to_device', 'set_device', 'get_model_device', 'USE_CUDA', 'x_to_preds', 'gather_lps',
           'average_batches', 'smooth_batches', 'pad_and_merge', 'merge_weights', 'merge_models', 'discount_rewards',
           'whiten', 'scatter_rewards', 'compute_advantages', 'CrossEntropy', 'HuberLoss']
