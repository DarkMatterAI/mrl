...
__all__ = ['to_mol', 'to_smile', 'to_mols', 'to_smiles', 'molwt', 'hbd', 'hba', 'tpsa', 'rotbond', 'fsp3', 'logp',
           'rings', 'heteroatoms', 'aromaticrings', 'Catalog', 'SmartsCatalog', 'ParamsCatalog', 'PAINSCatalog',
           'PAINSACatalog', 'PAINSBCatalog', 'PAINSCCatalog', 'ZINCCatalog', 'BRENKCatalog', 'morgan_fp', 'ECFP4',
           'ECFP6', 'FCFP4', 'FCFP6', 'fp_to_array', 'tanimoto', 'tanimoto_rd', 'dice', 'dice_rd', 'cosine',
           'cosine_rd', 'FP', 'get_fingerprint', 'fingerprint_similarities', 'fuse_on_atom_mapping', 'fuse_on_link']
...
def get_fingerprint(mol, fp_type):
    fp = FP()
    return fp.get_fingerprint(mol, fp_type)
