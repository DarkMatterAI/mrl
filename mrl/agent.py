...
__all__ = ['Agent', 'PredictiveAgent', 'PredictiveAgent', 'GenerativeAgent', 'ModelOutput']
...
class Agent():
    def __init__(self, model, loss_function, dataset):
        self.model = model
...
class GenerativeAgent(Agent):
    def __init__(self, model, vocab, loss_function, dataset,
                 base_model=True, value_head=None):
        ...
        if self.value_head is not None:
            self.value_opt = self.get_opt(self.value_head)
    ...
    def reconstruct(self, preds):
        return maybe_parallel(self.vocab.reconstruct, [i for i in preds])
