...
__all__ = ['SMILES_CHAR_VOCAB', 'SPECIAL_TOKENS', 'MAPPING_TOKENS', 'HALOGEN_REPLACE', 'MAPPING_REPLACE',
           'AMINO_ACID_VOCAB', 'SMILE_REGEX', 'MAPPING_REGEX', 'AA_MAPPING_REGEX', 'tokenize_by_character',
           'tokenize_with_replacements', 'regex_tokenize', 'Vocab', 'CharacterVocab', 'CharacterReplaceVocab',
           'RegexVocab', 'test_reconstruction', 'batch_sequences', 'lm_collate', 'seq_to_seq_collate',
           'sequence_prediction_collate', 'vector_collate', 'vector_reconstruction_collate',
           'vector_prediction_collate', 'BaseDataset', 'TextDataset', 'TextToTextDataset', 'TextPredictionDataset',
           'Vector_Dataset', 'Vec_Recon_Dataset', 'Vec2Text_Dataset', 'Vec_Prediction_Dataset']
