...
__all__ = ['ScoreFunction', 'NoScore', 'PassThroughScore', 'WeightedPropertyScore', 'PropertyFunctionScore',
           'ConstantScore', 'LinearDecayScore', 'Filter', 'ValidityFilter', 'SingleCompoundFilter', 'PropertyFilter',
           'MolWtFilter', 'HBDFilter', 'HBAFilter', 'TPSAFilter', 'RotBondFilter', 'SP3Filter', 'LogPFilter',
           'RingFilter', 'HeteroatomFilter', 'AromaticRingFilter', 'HeavyAtomsFilter', 'MRFilter', 'ChargeFilter',
           'TotalAtomFilter', 'QEDFilter', 'SAFilter', 'StructureFilter', 'ExclusionFilter', 'FPFilter']
...
class WeightedPropertyScore(ScoreFunction):
    ...
    def __init__(self, weight=1., fail_score=0.):
        self.weight = weight
        self.fail_score = fail_score

    def __call__(self, property_output, criteria_output):
        if criteria_output:
            output = property_output * self.weight
        else:
